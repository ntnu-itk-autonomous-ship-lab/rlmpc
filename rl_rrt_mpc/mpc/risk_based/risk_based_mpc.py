...
import rl_rrt_mpc.mpc.risk_based.casadi_mpc as casadi_mpc
...
if uname_result.machine == "arm64" and uname_result.system == "Darwin":
    ...
    import rl_rrt_mpc.mpc.risk_based.acados_mpc as acados_mpc
...
class Config:
    ...
    mpc: mpc_parameters.RiskBasedMPCParams = mpc_parameters.RiskBasedMPCParams()
    ...
    def from_dict(self, config_dict: dict):
        ...
        config = Config(
            ...
            mpc=mpc_parameters.RiskBasedMPCParams.from_dict(config_dict["params"]),
...
class RiskBasedMPC(mpc_interface.IMPC):
    ...
    @property
    def params(self) -> mpc_parameters.RiskBasedMPCParams:
        return self._params
