...
def objective(trial: optuna.Trial) -> float:
    ...
    """
    base_dir = Path.home() / "machine_learning/rlmpc/sac_critics"
    ...
    mpc_param_provider_kwargs = {
        ...
        # / "machine_learning/rlmpc/dnn_pp/pretrained_dnn_pp_HD_1315_1579_ReLU/best_model.pth",
    }
    policy_kwargs = {
    ...
    name = (
        "pretrained_sac_critics_HD_"
        + hidden_dims_str
        + f"_{actfn_str}"
        + f"_ent_coef{ent_coef}"
    )
