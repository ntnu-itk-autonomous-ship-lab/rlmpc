"""Training a standard SAC agent with NMPC parameter provider DNN policy and simpler feature extractor.
...
def main(args):
    ...
    parser.add_argument("--max_num_loaded_train_scen_episodes", type=int, default=2)
