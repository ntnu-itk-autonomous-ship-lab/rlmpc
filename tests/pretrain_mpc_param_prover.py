...
def train(
    ...
    for epoch in range(n_epochs):
        ...
        for batch_idx, batch_obs in enumerate(training_dataloader):
            ...
            # Forward pass
            mpc_param_increment = model(features, current_mpc_params, prev_action)
            loss = loss_functions.mpc_parameter_provider_loss(reconstructed_obs, batch_obs, seq_lengths)
