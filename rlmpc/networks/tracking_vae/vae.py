...
from rlmpc.networks.tracking_vae.decoder import TrackingDecoder
from rlmpc.networks.tracking_vae.encoder import TrackingEncoder
...
class VAE(nn.Module):
    ...
    def forward(self, x: th.Tensor, seq_lengths: th.Tensor) -> Tuple[th.Tensor, th.Tensor, th.Tensor, th.Tensor]:
        ...
        x_recon = self.decoder(z_sampled, max_seq_len)
